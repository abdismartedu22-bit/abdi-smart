const programs = [
  {
    tag: 'Privat',
    title: 'Les\nPrivat',
    desc: 'Sesi 1-on-1 eksklusif. Jadwal fleksibel, materi personal sesuai target kampus dan kelemahan kamu.',
    features: ['Jadwal bebas', 'Materi personal', 'Report mingguan'],
  ...
  },
  {
    ...
    features: ['Maks. 8 siswa', 'Simulasi UTBK', 'Diskusi aktif'],
  ...
  },
  {
    tag: 'TPS',
    title: 'TPS\nIntensif',
    desc: 'Fokus Tes Potensi Skolastik: Penalaran Umum, Kuantitatif, Literasi, dan Pengetahuan Umum.',
    features: ['Soal terbaru', 'Analisis skor', 'Tryout berkala'],
  ...
  },
  {
    tag: 'Mapel',
    title: 'Mata\nPelajaran',
    desc: 'Pendalaman bidang studi sesuai jurusan impian: Matematika, Sains, Ekonomi, Bahasa, dan Sosial.',
